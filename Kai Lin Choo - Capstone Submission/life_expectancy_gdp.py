...
print('Chile, China, Germany, Mexico, United States and Zimbabwe ')
...
print("no. The discrepencies between the life expectancy at birth in each country is much higher than the GDP in each country.")
...
print('China has changed the most when it comes to GDP, whereas Zimbabwe has changed the most with regards to life expectancy at birth.')
print('It is difficult to tell.')
print('Zimbabwe')
print('All countries have experienced increases in both GDP and Life expectancy at birth, though some countries have increased at a more rapid pace than others. China has experienced the most rapid increase in its GDP, while Zimbabwe has experienced the most rapid increase in its life expectancy rates.')
print('There is little evidence from the two bar charts to suggest a correlation between GDP and life expectancy')
print('Zimbabwe had more scope to raise life expectancy, given that is was starting from a lower base than typically found elsewhere in the world, hence its not surprising that its GDP increased as a considerably faster rate than the other five countries. China was able to expereinced such rapid rates of GDP growth likely due to the success of export-oriented trade policies.')
...
plt.show()
plt.savefig('scattergraphs_gdp_lifeexpectancy_bycountry.png')
...
print('China')
print('Zimbabwe')
print('No. This insight was also reflected in the bar charts.')
print('Not really')
...
g3 = (g3.map(plt.plot, "Year", "LEABY",color="r").add_legend())
plt.show()
plt.savefig('linegraphs_LEABYbycountry.png')
...
g2 = (g2.map(plt.plot, "Year", "GDP", color='g').add_legend())
plt.show()
plt.savefig('linegraphs_GDPbycountry.png')
...
print('The USA has the highest GDP and Zimbabwe has the lowest GDP.')
...
print('Germany has the highest life expectancy while Zimbabwe has the lowest life expectancy.')
...
print('What happened in China in the past 10 years that increased the GDP so drastically?')
